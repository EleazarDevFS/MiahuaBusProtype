      ...
      <div className="flex-1 flex flex-col px-6 pt-12 pb-8">
        ...
        >
          ...
          <div className="flex items-center gap-3 my-6">
            ...
            <span className="text-xs text-gray-400 uppercase tracking-wide">O continúa con</span>
            <div className="h-px flex-1 bg-gray-200" />
          </div>
          ...
          <button
            ...
            className="w-full bg-white border-2 border-gray-200 text-gray-900 py-4 rounded-xl flex items-center justify-center gap-3 hover:border-[#2E7D32] hover:bg-green-50 transition-all shadow-sm disabled:opacity-60 disabled:cursor-not-allowed"
          >
            ...
            <span>{googleLoading ? 'Entrando con Google...' : 'Iniciar sesión con Google'}</span>
          </button>
          ...
          <div className="flex items-center justify-between mt-6 text-sm">
            ...
            <button className="text-gray-600 hover:text-[#2E7D32]">
