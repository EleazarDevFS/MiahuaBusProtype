...
import { ArrowUpDown, MapPin, Search, Clock, ChevronRight, Info } from 'lucide-react';
...
export default function Planner() {
  ...
  React.useEffect(() => {
    // When opening the Planner, if permission isn't granted, block planning and show message
  ...
  const handleSearch = () => {
    ...
    if (currentPermission !== 'granted') {
      // block planning but allow viewing routes
      setShowBlockedMessage(true);
      setResults(null);
      setSearched(false);
      setActiveField(null);
    ...
    <div className="min-h-screen w-full bg-[#F8F9FA] pb-20">
      ...
      <div className="pt-[104px] px-4 py-4">
        ...
        <div className="bg-white border border-gray-200 rounded-2xl overflow-hidden shadow-sm mb-4">
          ...
          <div className="relative">
            <div className="flex items-center gap-3 px-4 py-3.5">
              ...
              />
              {origin && (
                <button onClick={() => { setOrigin(''); setResults(null); setSearched(false); }} className="text-gray-300 hover:text-gray-500">
                  ✕
                </button>
              )}
            </div>
          ...
          <div className="relative">
            <div className="flex items-center gap-3 px-4 py-3.5">
              ...
              />
              {destination && (
                <button onClick={() => { setDestination(''); setResults(null); setSearched(false); }} className="text-gray-300 hover:text-gray-500">
                  ✕
                </button>
              )}
            </div>
        ...
        <motion.button
          ...
          className="w-full py-3.5 bg-[#2E7D32] text-white rounded-xl text-sm flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed mb-5 shadow-md"
        >
            ...
            <div className="p-4 bg-yellow-50 border border-yellow-200 rounded-xl text-sm text-gray-700">
              ...
              <div className="flex gap-2">
                <button
                  ...
                  className="py-2 px-3 bg-[#2E7D32] text-white rounded-xl text-sm"
                >
                  Dar permiso
                </button>
                <button
        ...
        {!showBlockedMessage && !searched && (
          <div>
            <p className="text-xs text-gray-500 mb-3">Rutas comunes</p>
            ...
            >
              {results.length === 0 ? (
                <div className="text-center py-10">
                  ...
                  <p className="text-gray-700 mb-1">Sin rutas directas</p>
                        ...
                        >
                          ...
                          <div className="flex items-center gap-3 text-xs text-gray-600">
                            <div className="flex items-center gap-1">
                              ...
                              {next
                                ? <span className="text-[#2E7D32]">Próximo: {next.time} ({formatMins(next.minutesAway)})</span>
      ...
      <PermissionModal
        ...
        onSuccess={() => {
          ...
          // once granted, automatically perform search if fields were filled
